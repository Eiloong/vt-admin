...
export default {
  ...
  login: {
    ...
    mobilePlaceholder1: 'Please input mobile phone number',
    mobilePlaceholder2: 'Please enter the verification code',
    mobileCodeText: 'Get code',
    btnText: 'Sign in',
    msgText:
    ...
    scanText: 'Open the mobile phone to scan and quickly log in / register',
