    ...
    <el-card shadow="hover">
      ...
      <el-table :data="tableData.data" style="width: 100%">
        ...
        <el-table-column label="操作" width="100">
          <template #default="scope">
            <el-button text type="primary" size="small" @click="onOpenEditDic(scope.row)">修改</el-button>
            <el-button text size="small" @click="onRowDel(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
...
import AddDic from './component/AddDic.vue'
