    ...
    <el-card shadow="hover">
      ...
      <el-table :data="tableData.data" style="width: 100%">
        ...
        <el-table-column label="操作" width="100">
          <template #default="scope">
            <el-button :disabled="scope.row.userName === 'admin'" size="small" text @click="onOpenEditUser(scope.row)"
              >修改</el-button
            >
            <el-button :disabled="scope.row.userName === 'admin'" size="small" text @click="onRowDel(scope.row)"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
import AddUer from './component/AddUser.vue'
